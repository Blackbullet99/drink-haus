...
const StrawberryBasil = () => {
  const { strawberrybasil } = useParams();

  return (
    <ProductContainer>
      <ProductContent>
        <h1>
          <span>the</span> {strawberrybasil}
        </h1>
        <img src={strawberryBasil} alt="strawberrybasil" />
      </ProductContent>
      <ProductDescription>
...
export default StrawberryBasil;